...
write('<!DOCTYPE html>
  ...
  <title>HTML gPCA</title></head><body><p>If you are seeing this then CSS is whitelisted</p><h2 id = "top">Table of Contents</h2><ul>', file = opt$html_outfile, append=TRUE)
